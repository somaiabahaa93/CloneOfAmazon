...
import AdminAddSubCategoryHook from '../../hook/SubCategory/AdminAddSubCategoryHook';

const AdminAddSubCategory = () => {
   const [id, name, loading, category, subcategory, handelChange, handelSubmit, onChangeName]=AdminAddSubCategoryHook()
